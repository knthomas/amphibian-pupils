...
Now that we've converted taxonomy, we can look at species numbers again (according to ASW).

Yovanovich et al.
- `r length(levels(as.factor(yovanovich.ASW$genus_species)))` species according to ASW


Cervino et al. 
- `r length(levels(as.factor(cervino.ASW$genus_species)))` species according to ASW
