...
We have 73 species, each representing one family sampled. Now we prune the tree to match. 
...
#add legend for pupil shape
legend(x = 200, y = 1325, legend = c("almond or slit", "circle", "diamond", "sideways triangle", "inverted tear", "inverted triangle"), 
       col = "black", pt.bg = "black",
       pch = sh_shape, #shape of labels
       cex = 0.7, 
       box.lty = 0, 
