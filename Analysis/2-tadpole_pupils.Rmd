...
We have collected adult/tadpole pupil data from `r length(levels(as.factor(pupils.tads$genus_species)))` species representing `r length(levels(as.factor(pupils.tads$Genus)))` genera and `r length(levels(as.factor(pupils.tads$Family)))` families. 
