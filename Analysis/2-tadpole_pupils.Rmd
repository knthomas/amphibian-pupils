...
#look at all the combinations of constriction and shapes in the adults from our tadpole subset
tad.states <- pupils.tads_pruned %>%
  group_by(Final_Constriction, Final_Shape) %>%
...
tiplabels(col = "black", bg = "white", frame = "none", adj = 0,
          text = sh_shape[pupils.tads$Final_Shape], #shape of labels
          cex = 0.7,
          offset = 8)
...
#add tip labels for adult pupil shape
tiplabels(col = "black", bg = "white", frame = "none", adj = 0,
          text = sh_shape[pupils.tads_pruned$Final_Shape], #shape of labels
          cex = 0.7,
          offset = 8)
